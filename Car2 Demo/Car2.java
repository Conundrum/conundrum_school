...
public class Car2
{
    ...
    { 
        ...
        rotationInRadians = ((rotationInDegrees * 3.14) / 180);
        
        // Calculate the distance to move in both x and y directions
        double distX = dist;
        double distY = 0.0;
        distX = dist * (Math.cos(rotationInRadians));
        distY = dist * (Math.sin(rotationInRadians));
        ...
        IO.outputln("degrees = " + rotationInDegrees + "   radians = " + rotationInRadians);
        IO.outputln("dist x = " + distX + "     dist y = " + distY);
